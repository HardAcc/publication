...
set xrange [0.5:30000]
set xlabel "Mean {/Symbol l}"
set logscale x 10
...
# plot
plot "poisson.dat" using 1:($2/16) with linespoints ls 1 title "optimized",\
     "poisson.dat" using 1:($4/16) with linespoints ls 2 title "original"
